    ...
    <div class="content__mtStatus px-2">
        <div class="py-1 d-flex justify-content-between align-items-center" style="border-bottom: 1px solid #F0F0F0">
            <h5 class="mb-0 d-flex align-items-center gap-3 py-2  px-3 rounded"
               ...
               >
                Trash
                <i class="fa fa-trash-can text-black-50"></i>
            </h5>
        ...
        @if($folders)
            ...
            <div class="myDrive__container d-flex align-items-center gap-3 flex-wrap">
                ...
                @forelse($folders as $folder)
                    <a href="{{ route('drive.trashFolderFile', $folder->id) }}" class="folder__container text-decoration-none d-flex align-items-center gap-5 px-3 rounded-2">
                ...
                @empty
                    ...
                    <div class="d-flex justify-content-center align-items-center empty__container">
                        <h4 class="mb-0 fw-bold text-black-50">Empty Trash Folder . . . . .</h4>
                    </div>
        ...
        <div class="myDrive__container d-flex align-items-center gap-3 flex-wrap">
            @forelse($drives as $drive)
                ...
                >
                    ...
                    <x-tcontroller folder="false" :fileId="$drive->id" />
                </div>
            @empty
                <div class="d-flex justify-content-center align-items-center empty__container">
                    <h4 class="mb-0 fw-bold text-black-50">Empty Trash File . . . . .</h4>
                </div>
            @endforelse
